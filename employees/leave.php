                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">แบบฟอร์มยื่นคำร้องขอลา</h4>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">กรุณากรอกแบบฟอร์มด้านล่าง</p>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">วันเริ่มต้นการลา</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">วันสิ้นสุดการลา</label>
                                            <input class="form-control" type="date" value="2020-03-05" data-inputmask="'alias': 'date'" required id="example-date-input" name="todate">
                                        </div>

                                        <div class="form-group">
                                            <label class="col-form-label">ประเภทการลาของคุณ</label>
                                        ...
                                        <button class="btn btn-primary" name="apply" id="apply" type="submit">ตกลง</button>
